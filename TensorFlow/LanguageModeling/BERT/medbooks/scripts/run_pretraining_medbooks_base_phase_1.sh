...
RESULTS_DIR=/results
CHECKPOINTS_DIR=${RESULTS_DIR}/medbooks_phase_1
...
INPUT_FILES_DIR="/workspace/bert/data/tfrecord/lower_case_${DO_LOWER_CASE}_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5_shard_490_test_split_10/medbooks/training"
EVAL_FILES_DIR="/workspace/bert/data/tfrecord/lower_case_${DO_LOWER_CASE}_seq_len_128_max_pred_20_masked_lm_prob_0.15_random_seed_12345_dupe_factor_5_shard_490_test_split_10/medbooks/test"
...
printf -v TAG "tf_bert_medbooks_1n_phase1_cased_%s_%s_gbs%d" "$cased" "$precision" $GBS
